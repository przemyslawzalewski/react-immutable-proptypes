...
describe("ImmutablePropTypes", function () {
  ...
  describe("MapOf Type", function () {
    ...
    it("should support keys validation by passing typeChecker as a second argument", function () {
      ...
      typeCheckPass(PropTypes.mapOf(React.PropTypes.any, React.PropTypes["function"]), Immutable.Map([[function () {
        return 1 + 1;
      }, 1], [function (foo) {
        return "bar";
      }, 2]]));
  ...
  describe("OrderedMapOf Type", function () {
    ...
    it("should support keys validation by passing typeChecker as a second argument", function () {
      ...
      typeCheckPass(PropTypes.orderedMapOf(React.PropTypes.any, React.PropTypes["function"]), Immutable.OrderedMap([[function () {
        return 1 + 1;
      }, 1], [function (foo) {
        return "bar";
      }, 2]]));
